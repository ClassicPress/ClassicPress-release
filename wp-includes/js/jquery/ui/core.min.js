 ...
 * https://api.jqueryui.com/position/
 */
s=Math.max,r=Math.abs,l=/left|center|right/,a=/top|center|bottom/,h=/[\+\-]\d+(\.[\d]+)?%?/,f=/^\w+/,u=/%$/,c=t.fn.position,t.position={scrollbarWidth:function(){var e,i,n;return void 0!==o?o:(n=(i=t("<div style='display:block;position:absolute;width:200px;height:200px;overflow:hidden;'><div style='height:300px;width:auto;'></div></div>")).children()[0],t("body").append(i),e=n.offsetWidth,i.css("overflow","scroll"),e===(n=n.offsetWidth)&&(n=i[0].clientWidth),i.remove(),o=e-n)},getScrollInfo:function(e){var i=e.isWindow||e.isDocument?"":e.element.css("overflow-x"),n=e.isWindow||e.isDocument?"":e.element.css("overflow-y");i="scroll"===i||"auto"===i&&e.width<e.element[0].scrollWidth;return{width:"scroll"===n||"auto"===n&&e.height<e.element[0].scrollHeight?t.position.scrollbarWidth():0,height:i?t.position.scrollbarWidth():0}},getWithinInfo:function(e){var i=t(e||window),n=m(i[0]),o=!!i[0]&&9===i[0].nodeType;return{element:i,isWindow:n,isDocument:o,offset:n||o?{left:0,top:0}:t(e).offset(),scrollLeft:i.scrollLeft(),scrollTop:i.scrollTop(),width:i.outerWidth(),height:i.outerHeight()}}},t.fn.position=function(e){var i,n,o,u,d,v,y,w,b,_,x,W;return e&&e.of?(v="string"==typeof(e=t.extend({},e)).of?t(document).find(e.of):t(e.of),y=t.position.getWithinInfo(e.within),w=t.position.getScrollInfo(y),b=(e.collision||"flip").split(" "),_={},W=9===(W=(x=v)[0]).nodeType?{width:x.width(),height:x.height(),offset:{top:0,left:0}}:m(W)?{width:x.width(),height:x.height(),offset:{top:x.scrollTop(),left:x.scrollLeft()}}:W.preventDefault?{width:0,height:0,offset:{top:W.pageY,left:W.pageX}}:{width:x.outerWidth(),height:x.outerHeight(),offset:x.offset()},v[0].preventDefault&&(e.at="left top"),n=W.width,o=W.height,d=t.extend({},u=W.offset),t.each(["my","at"],(function(){var t,i,n=(e[this]||"").split(" ");(n=1===n.length?l.test(n[0])?n.concat(["center"]):a.test(n[0])?["center"].concat(n):["center","center"]:n)[0]=l.test(n[0])?n[0]:"center",n[1]=a.test(n[1])?n[1]:"center",t=h.exec(n[0]),i=h.exec(n[1]),_[this]=[t?t[0]:0,i?i[0]:0],e[this]=[f.exec(n[0])[0],f.exec(n[1])[0]]})),1===b.length&&(b[1]=b[0]),"right"===e.at[0]?d.left+=n:"center"===e.at[0]&&(d.left+=n/2),"bottom"===e.at[1]?d.top+=o:"center"===e.at[1]&&(d.top+=o/2),i=p(_.at,n,o),d.left+=i[0],d.top+=i[1],this.each((function(){var l,a,h=t(this),f=h.outerWidth(),c=h.outerHeight(),m=g(this,"marginLeft"),x=g(this,"marginTop"),W=f+m+g(this,"marginRight")+w.width,C=c+x+g(this,"marginBottom")+w.height,E=t.extend({},d),L=p(_.my,h.outerWidth(),h.outerHeight());"right"===e.my[0]?E.left-=f:"center"===e.my[0]&&(E.left-=f/2),"bottom"===e.my[1]?E.top-=c:"center"===e.my[1]&&(E.top-=c/2),E.left+=L[0],E.top+=L[1],l={marginLeft:m,marginTop:x},t.each(["left","top"],(function(s,r){t.ui.position[b[s]]&&t.ui.position[b[s]][r](E,{targetWidth:n,targetHeight:o,elemWidth:f,elemHeight:c,collisionPosition:l,collisionWidth:W,collisionHeight:C,offset:[i[0]+L[0],i[1]+L[1]],my:e.my,at:e.at,within:y,elem:h})})),e.using&&(a=function(t){var i=u.left-E.left,l=i+n-f,a=u.top-E.top,d=a+o-c,p={target:{element:v,left:u.left,top:u.top,width:n,height:o},element:{element:h,left:E.left,top:E.top,width:f,height:c},horizontal:l<0?"left":0<i?"right":"center",vertical:d<0?"top":0<a?"bottom":"middle"};n<f&&r(i+l)<n&&(p.horizontal="center"),o<c&&r(a+d)<o&&(p.vertical="middle"),s(r(i),r(l))>s(r(a),r(d))?p.important="horizontal":p.important="vertical",e.using.call(this,t,p)}),h.offset(t.extend(E,{using:a}))}))):c.apply(this,arguments)},t.ui.position={fit:{left:function(t,e){var i,n=(o=e.within).isWindow?o.scrollLeft:o.offset.left,o=o.width,r=t.left-e.collisionPosition.marginLeft,l=n-r,a=r+e.collisionWidth-o-n;e.collisionWidth>o?0<l&&a<=0?(i=t.left+l+e.collisionWidth-o-n,t.left+=l-i):t.left=!(0<a&&l<=0)&&a<l?n+o-e.collisionWidth:n:0<l?t.left+=l:0<a?t.left-=a:t.left=s(t.left-r,t.left)},top:function(t,e){var i,n=(n=e.within).isWindow?n.scrollTop:n.offset.top,o=e.within.height,r=t.top-e.collisionPosition.marginTop,l=n-r,a=r+e.collisionHeight-o-n;e.collisionHeight>o?0<l&&a<=0?(i=t.top+l+e.collisionHeight-o-n,t.top+=l-i):t.top=!(0<a&&l<=0)&&a<l?n+o-e.collisionHeight:n:0<l?t.top+=l:0<a?t.top-=a:t.top=s(t.top-r,t.top)}},flip:{left:function(t,e){var i=(o=e.within).offset.left+o.scrollLeft,n=o.width,o=o.isWindow?o.scrollLeft:o.offset.left,s=(l=t.left-e.collisionPosition.marginLeft)-o,l=l+e.collisionWidth-n-o,a="left"===e.my[0]?-e.elemWidth:"right"===e.my[0]?e.elemWidth:0,h="left"===e.at[0]?e.targetWidth:"right"===e.at[0]?-e.targetWidth:0,f=-2*e.offset[0];s<0?((n=t.left+a+h+f+e.collisionWidth-n-i)<0||n<r(s))&&(t.left+=a+h+f):0<l&&(0<(i=t.left-e.collisionPosition.marginLeft+a+h+f-o)||r(i)<l)&&(t.left+=a+h+f)},top:function(t,e){var i=(o=e.within).offset.top+o.scrollTop,n=o.height,o=o.isWindow?o.scrollTop:o.offset.top,s=(l=t.top-e.collisionPosition.marginTop)-o,l=l+e.collisionHeight-n-o,a="top"===e.my[1]?-e.elemHeight:"bottom"===e.my[1]?e.elemHeight:0,h="top"===e.at[1]?e.targetHeight:"bottom"===e.at[1]?-e.targetHeight:0,f=-2*e.offset[1];s<0?((n=t.top+a+h+f+e.collisionHeight-n-i)<0||n<r(s))&&(t.top+=a+h+f):0<l&&(0<(i=t.top-e.collisionPosition.marginTop+a+h+f-o)||r(i)<l)&&(t.top+=a+h+f)}},flipfit:{left:function(){t.ui.position.flip.left.apply(this,arguments),t.ui.position.fit.left.apply(this,arguments)},top:function(){t.ui.position.flip.top.apply(this,arguments),t.ui.position.fit.top.apply(this,arguments)}}},t.ui.safeActiveElement=function(t){var i;try{i=t.activeElement}catch(e){i=t.body}return(i=i||t.body).nodeName?i:t.body},t.ui.safeBlur=function(e){e&&"body"!==e.nodeName.toLowerCase()&&t(e).trigger("blur")},
/*!
 * jQuery UI Scroll Parent 1.13.3
 * https://jqueryui.com
 *
